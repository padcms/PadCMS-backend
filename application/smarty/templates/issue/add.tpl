                ...
                <div class="cblock-form-inner">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-item{if isset($number) && $number.errors} error{/if}">
                            ...
                            <div class="form-item-wrapper">{if isset($number)}{include file="Volcano/input.tpl" control=$number _class="form-text"}{/if}</div>
                            <div class="clr"></div>
                            <div class="description">
                        ...
                        <div class="form-item{if isset($product_id) && $product_id.errors} error{/if}">
                            ...
                            <div class="clr"></div>
                            <div class="description">
                                {'Product ID like '|translate} com.adyax.padcms.issue_{if isset($issue) && $issue.primaryKeyValue}{$issue.primaryKeyValue}{else}ID{/if}
                            </div>
                        </div>
                        ...
                        <div class="form-item{if isset($summary_color) && $summary_color.errors} error{/if}">
                            ...
                            <div class="form-item-wrapper with-color-picker" >
                                ...
                                {/if}
                                <div class="color-selector">
                                    <div style="background-color: #{if isset($summary_color)}{$summary_color.value}{/if};"/></div>
                                </div>
                            </div>
                            <div class="clr"></div>
                            <div class="description"></div>
                        ...
                        <div class="form-item select-themed{if isset($orientation) && $orientation.errors} error{/if}">
                            ...
                            {/if}
                            <div class="form-item-wrapper">{if isset($orientation)}{include file="Volcano/select.tpl" control=$orientation _values=$issue.orientations _class="form-text" _disabled=$orientation_disbaled}{/if}</div>
                        </div>
                        {/if}
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-item-wrapper" id="ctype">
                                <div>
                                    <input type="radio" name="type" value="enriched" id="radio_type_enriched" {if isset($type)}{if $type.value == 'enriched' || !$type.value}checked="checked"{/if}{/if}>
                                    <label for="radio_type_enriched">{'Based on Multiple PDF'|translate}</label>
                                </div>
                                <div>
                                    <input type="radio" name="type" value="simple" id="radio_type_simple" {if isset($type) && $type.value == 'simple'}checked="checked"{/if}>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-item-wrapper" id="ctype">
                                <div>
                                    <input type="radio" name="pdf_type" value="none" id="radio1" {if $pdf_type.value == 'none' || !$pdf_type.value}checked="checked"{/if}>
                                    <label for="radio1">{'None'|translate}</label>
                                </div>
                                <div>
                                    <input type="radio" name="pdf_type" value="issue" id="radio1" {if $pdf_type.value == 'issue'}checked="checked"{/if}>
                                    <label for="radio1">{'One PDF'|translate}</label>
                                </div>
                                <div>
                                    <input type="radio" name="pdf_type" value="page" id="radio2" {if $pdf_type.value == 'page'}checked="checked"{/if}>
                                    <label for="radio2">{'One PDF per page'|translate}</label>
                                </div>
                                <div>
                                    <input type="radio" name="pdf_type" value="2pages" id="radio3" {if $pdf_type.value == '2pages'}checked="checked"{/if}>
                    ...
                    {if isset($issue) && $issue.primaryKeyValue && $type.value == 'simple'}
                        ...
                        <div id="simple-pdf-wrapper" class="static-pdf-wrapper">
                            <div class="upload-btn">
                                <form action="/issue/upload-simple-pdf/iid/{if isset($issue)}{$issue.primaryKeyValue}{/if}" class="simple-pdf-upload-form" method="post">
                                    ...
                                    <li id="simple-pdf">
                                        <div class="data-item">
                                            <a rel="undefined" href="{if isset($issue)}{$issue.simplePdf.bigUri}{/if}" class="simple_pdf_image">
                                                <img height="96" width="72" src="{if isset($issue)}{$issue.simplePdf.smallUri}{/if}" alt="{if isset($issue)}{$issue.simplePdf.name}{/if}">
                                            </a>
                                            <span title="{if isset($issue)}{$issue.simplePdf.name}{/if}" class="name">{if isset($issue)}{$issue.simplePdf.nameShort}{/if}</span>
                    ...
                    {if isset($issue) && $issue.primaryKeyValue && $pdf_type.value != 'none' && $pdf_type.value != null}
                        ...
                        <div id="static-pdf-wrapper" class="static-pdf-wrapper">
                            <div class="upload-btn">
                                <form action="/issue/upload/iid/{if isset($issue)}{$issue.primaryKeyValue}{/if}" class="upload-form" method="post">
                                    <span class="file-wrapper">
                                        <a href="#" class="cbutton"><span><span class="ico">{'Upload'|translate}</span></span></a>
                    ...
                    {if isset($issue) && $issue.primaryKeyValue && isset($orientation) && $orientation.value == 'vertical'}
                        ...
                        <div id="vertical-help-page-wrapper" class="static-pdf-wrapper">
                            <div class="upload-btn">
                                <form action="/issue/upload-help-page/iid/{$issue.primaryKeyValue}/type/vertical" class="vertical-help-page-upload-form" method="post">
                                    <span class="file-wrapper">
                                        <a href="#" class="cbutton"><span><span class="ico">{'Upload'|translate}</span></span></a>
                                        <input type="file" name="vertical-help-page-file" class="vertical-help-page-file"/>
                                    </span>
                                </form>
                            </div>
                                    ...
                                    <li id="vertical-help-page">
                                        <div class="data-item">
                                            <a rel="undefined" href="{$issue.verticalHelpPage.bigUri}" class="vertical-help-page-image">
                                                <img height="96" width="72" src="{$issue.verticalHelpPage.smallUri}" alt="{$issue.verticalHelpPage.name}">
                                            </a>
                    ...
                    {if isset($issue) && $issue.primaryKeyValue}
                        ...
                        <div id="horizontal-help-page-wrapper" class="static-pdf-wrapper">
                            <div class="upload-btn">
                                <form action="/issue/upload-help-page/iid/{$issue.primaryKeyValue}/type/horizontal" class="horizontal-help-page-upload-form" method="post">
                                    <span class="file-wrapper">
                                        <a href="#" class="cbutton"><span><span class="ico">{'Upload'|translate}</span></span></a>
                                        <input type="file" name="horizontal-help-page-file" class="horizontal-help-page-file"/>
                                    </span>
                                </form>
                            </div>
                                    ...
                                    <li id="horizontal-help-page">
                                        <div class="data-item">
                                            <a rel="undefined" href="{$issue.horizontalHelpPage.bigUri}" class="horizontal-help-page-image">
                                                <img height="72" width="96" src="{$issue.horizontalHelpPage.smallUri}" alt="{$issue.horizontalHelpPage.name}">
                                            </a>
