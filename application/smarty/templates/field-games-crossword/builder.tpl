<style>
    ...
    #gridContainer { width: 330px; height: 330px; margin: 0 auto; font-family: Helvetica, Arial, sans-serif; }
    #controlsPanel { width: 200px; height: auto; margin: 0 auto; }

    #questionsList { width: 500px; margin: 0 auto; min-height: 200px; }
...
<div id="controlsPanel">
    <button id="disableResising">Finish resising</button>
