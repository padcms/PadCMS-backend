 ...
 *
 * $files = AM_Tools_Finder::type('file')->name('*.php')->in(.);
 *
...
class AM_Tools_Finder
{
   ...
   *
   * @param  int $level
   * @return sfFinder current AM_Tools_Finder object
   */
   ...
   *
   * @param  int $level
   * @return AM_Tools_Finder current AM_Tools_Finder object
   */
   ...
   * @return AM_Tools_Finder new AM_Tools_Finder object
   */
   ...
   *
   * @param  string $name  directory or file or any (for both file and directory)
   * @return AM_Tools_Finder Current object
   */
