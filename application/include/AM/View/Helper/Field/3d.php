...
/**
 * @file
 * AM_View_Helper_Field_3d class definition.
 *
 * LICENSE
 *
 * $DOXY_LICENSE
 ...
 */
class AM_View_Helper_Field_3d extends AM_View_Helper_Field
{
    public function show()
    {
        ...
        $aExtensions = array_map('strtoupper', AM_Model_Db_Element_Data_3d::getAllowedFileExtensions());
